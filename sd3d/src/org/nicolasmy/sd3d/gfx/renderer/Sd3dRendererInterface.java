...
public interface Sd3dRendererInterface {
	...
	//public abstract void renderSceneFromLightPOV(Sd3dScene scene);
	
	//public abstract void renderShadowVolumeScene(Sd3dScene scene);
    ...
    //public abstract void renderPickableScene(Sd3dScene scene);
